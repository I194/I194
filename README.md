...
- I'm Frontend Developer, somewhere between L3 and L4. Currently working. More specific info about me in [my LinkedIn](https://www.linkedin.com/in/i1948374/). 
- My global pet project for last two years is the PMTools - it's an app for paleomagnetism data analysis and visualization. Currently new version of PMTools is under development, here  it's [repo](https://github.com/I194/PMTools_2.0) and [website for tests](https://pmtools.vercel.app/). You can also find the beta version of this app [here](https://github.com/I194/PMTools). 
